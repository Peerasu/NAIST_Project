...
# # Load the good model
# model_path = '../../../../../mnt/d/peerasu/models/model_1_epoch_11.pth'
...
model_save_path = '../../../../../mnt/d/peerasu/models_from_model_1_epoch_11'
result_save_path = '../train_results_from_model_1_epoch_11'
...
# dot.render("../models_info/resnet50_architecture", format="png")
...
for epoch in range(num_epochs):
    ...
    print(f'####### Epoch {epoch+12}/{num_epochs} #######')
    ...
    result_file_path = f'{result_save_path}/result_model_{model_num}_from_model_1_epoch_11.csv'
    ...
    # Save the model
    torch.save(model.state_dict(), os.path.join(model_save_path, f'model_{model_num}_epoch_{epoch+12}.pth'))
        
    print(f'------- Epoch {epoch+12}/{num_epochs}, Train Loss: {epoch_loss:.4f}, Test Loss: {test_loss:.4f}, Test Accuracy: {test_accuracy:.2f}%, Learning Rate: {current_lr} -------')
