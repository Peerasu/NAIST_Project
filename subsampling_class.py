...
new_dataset_dir = '../../../../../mnt/d/peerasu/NewNew/Patch_Train_SS'

# Path to the true train label CSV file
original_train_label = "../annotation_newnew/Label_Train.csv"

# Path to save the CSV file
csv_file_path = "../annotation_newnew/Label_Train_SS.csv"
...
for filename in tqdm(os.listdir(original_dataset_dir)):
    ...
    label = int(true_train_labels.get(name))
    ...
    if label == 1:
        ...
        csv_data.append({'Sample_Name': name, 'Label': label})
